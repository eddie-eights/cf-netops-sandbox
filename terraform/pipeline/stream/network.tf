...
resource "aws_security_group" "msk" {
  ...
  lifecycle {
    precondition {
      ...
      error_message = "terraform/pipeline/lab の state（terraform/pipeline/lab/terraform.tfstate）から lab_security_group_id / lab_role_name が読めない。terraform/pipeline/lab を先に apply する。"
    }
  }
}
