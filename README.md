...
| `opensearch`: OpenSearch Serverless の TIMESERIES コレクション | インデックス $0.326/OCU 時間、検索 $0.334/OCU 時間 | フェーズ 1 のコレクション（VECTORSEARCH 型）と OCU を共有するか確認できていない。共有されなければ最小 0.5 + 0.5 OCU で **+$0.33**、されれば 0 |
